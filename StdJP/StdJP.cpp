// StdJP.cpp --- KeybdPlugin StdJP keyboard
...
Plugin_Load(PLUGIN *pi, LPARAM lParam)
{
    ...
    pi->plugin_version = 2;
    StringCbCopy(pi->plugin_product_name, sizeof(pi->plugin_product_name), TEXT("StdJP"));
    StringCbCopy(pi->plugin_filename, sizeof(pi->plugin_filename), TEXT("StdJP.keybd"));
