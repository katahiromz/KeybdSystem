// FullJP.cpp --- KeybdPlugin FullJP keyboard
...
Plugin_Load(PLUGIN *pi, LPARAM lParam)
{
    ...
    pi->plugin_version = 2;
    StringCbCopy(pi->plugin_product_name, sizeof(pi->plugin_product_name), TEXT("FullJP"));
    StringCbCopy(pi->plugin_filename, sizeof(pi->plugin_filename), TEXT("FullJP.keybd"));
