// EasyEn.cpp --- KeybdPlugin StdEn keyboard
...
Plugin_Load(PLUGIN *pi, LPARAM lParam)
{
    ...
    pi->plugin_version = 2;
    StringCbCopy(pi->plugin_product_name, sizeof(pi->plugin_product_name), TEXT("EasyEn"));
    StringCbCopy(pi->plugin_filename, sizeof(pi->plugin_filename), TEXT("EasyEn.keybd"));
